...
/* pin banks of exynos1280 pin-controller 0 (ALIVE) */
static const struct samsung_pin_bank_data exynos1280_pin_banks0[] __initconst = {
	EXYNOS850_PIN_BANK_EINTW(8, 0x00, "gpa0", 0x00),
	EXYNOS850_PIN_BANK_EINTW(4, 0x20, "gpa1", 0x04),
	EXYNOS850_PIN_BANK_EINTN(4, 0x40, "gpq0"),
	EXYNOS850_PIN_BANK_EINTN(2, 0x60, "gpq1"),
	EXYNOS850_PIN_BANK_EINTW(1, 0x80, "gpc0", 0x08),
	EXYNOS850_PIN_BANK_EINTW(1, 0xa0, "gpc1", 0x0c),
	EXYNOS850_PIN_BANK_EINTW(1, 0xc0, "gpc2", 0x10),
	EXYNOS850_PIN_BANK_EINTW(1, 0xe0, "gpc3", 0x14),
	EXYNOS850_PIN_BANK_EINTW(1, 0x100, "gpc4", 0x18),
	EXYNOS850_PIN_BANK_EINTW(1, 0x120, "gpc5", 0x1c),
	EXYNOS850_PIN_BANK_EINTW(1, 0x140, "gpc6", 0x20),
	EXYNOS850_PIN_BANK_EINTW(1, 0x160, "gpc7", 0x24),
	EXYNOS850_PIN_BANK_EINTN(3, 0x180, "gpx0"),
};

/* pin banks of exynos1280 pin-controller 1 (CHUB) */
static const struct samsung_pin_bank_data exynos1280_pin_banks1[] __initconst = {
	EXYNOS850_PIN_BANK_EINTG(8, 0x00, "gph0",  0x00),
	EXYNOS850_PIN_BANK_EINTG(4, 0x20, "gph1",  0x04),
};

/* pin banks of exynos1280 pin-controller 2 (CMGP) */
static const struct samsung_pin_bank_data exynos1280_pin_banks2[] __initconst = {
...
/* pin banks of exynos1280 pin-controller 3 (HSI) */
static const struct samsung_pin_bank_data exynos1280_pin_banks3[] __initconst = {
	EXYNOS850_PIN_BANK_EINTG(2, 0x0, "gpf0", 0x00),
	EXYNOS850_PIN_BANK_EINTG(8, 0x20, "gpf1", 0x04),
};

/* pin banks of exynos1280 pin-controller 4 (HSI_UFS) */
static const struct samsung_pin_bank_data exynos1280_pin_banks4[] __initconst = {
	EXYNOS850_PIN_BANK_EINTW(2, 0x0, "gpf3", 0x00),
};

/* pin banks of exynos1280 pin-controller 5 (PERI) */
static const struct samsung_pin_bank_data exynos1280_pin_banks5[] __initconst = {
	EXYNOS850_PIN_BANK_EINTG(8, 0x0, "gpp0", 0x00),
	EXYNOS850_PIN_BANK_EINTG(8, 0x20, "gpp1", 0x04),
	EXYNOS850_PIN_BANK_EINTG(8, 0x40, "gpp2", 0x08),
	EXYNOS850_PIN_BANK_EINTG(6, 0x60, "gpp3", 0x0c),
	EXYNOS850_PIN_BANK_EINTG(5, 0x80, "gpg0", 0x10),
	EXYNOS850_PIN_BANK_EINTG(3, 0xa0, "gpg1", 0x14),
	EXYNOS850_PIN_BANK_EINTG(2, 0xc0, "gpg2", 0x18),
	EXYNOS850_PIN_BANK_EINTG(6, 0xe0, "gpb0", 0x1c),
	EXYNOS850_PIN_BANK_EINTG(4, 0x100, "gpb1", 0x20),
};

/* pin banks of exynos1280 pin-controller 6 (PERI_MMC) */
static const struct samsung_pin_bank_data exynos1280_pin_banks6[] __initconst = {
	EXYNOS850_PIN_BANK_EINTG(6, 0x0, "gpf2", 0x00),
};

/* pin banks of exynos1280 pin-controller 7 (VTS) */
static const struct samsung_pin_bank_data exynos1280_pin_banks7[] __initconst = {
	EXYNOS850_PIN_BANK_EINTG(4, 0x0, "gpv0", 0x00),
};

static const struct samsung_pin_ctrl exynos1280_pin_ctrl[] __initconst = {
	{
		.pin_banks	= exynos1280_pin_banks0,
		.nr_banks	= ARRAY_SIZE(exynos1280_pin_banks0),
	...
	{
		.pin_banks      = exynos1280_pin_banks1,
		.nr_banks       = ARRAY_SIZE(exynos1280_pin_banks1),
		.eint_gpio_init = exynos_eint_gpio_init,
		.eint_wkup_init = exynos_eint_wkup_init,
		.suspend        = exynos_pinctrl_suspend,
		.resume         = exynos_pinctrl_resume,
	...
	{
		.pin_banks      = exynos1280_pin_banks2,
		.nr_banks       = ARRAY_SIZE(exynos1280_pin_banks2),
		.eint_gpio_init = exynos_eint_gpio_init,
		.eint_wkup_init = exynos_eint_wkup_init,
		.suspend        = exynos_pinctrl_suspend,
		.resume         = exynos_pinctrl_resume,
	...
	{
		.pin_banks	= exynos1280_pin_banks3,
		.nr_banks	= ARRAY_SIZE(exynos1280_pin_banks3),
		.eint_gpio_init = exynos_eint_gpio_init,
		.suspend	= exynos_pinctrl_suspend,
		.resume		= exynos_pinctrl_resume,
	},
	{
		.pin_banks	= exynos1280_pin_banks4,
		.nr_banks	= ARRAY_SIZE(exynos1280_pin_banks4),
		.eint_gpio_init = exynos_eint_gpio_init,
		.suspend	= exynos_pinctrl_suspend,
		.resume		= exynos_pinctrl_resume,
	},
	{
		.pin_banks	= exynos1280_pin_banks5,
		.nr_banks	= ARRAY_SIZE(exynos1280_pin_banks5),
		.eint_gpio_init = exynos_eint_gpio_init,
		.suspend	= exynos_pinctrl_suspend,
		.resume		= exynos_pinctrl_resume,
	},
	{
		.pin_banks	= exynos1280_pin_banks6,
		.nr_banks	= ARRAY_SIZE(exynos1280_pin_banks6),
		.eint_gpio_init = exynos_eint_gpio_init,
		.suspend	= exynos_pinctrl_suspend,
		.resume		= exynos_pinctrl_resume,
	},
	{
		.pin_banks	= exynos1280_pin_banks7,
		.nr_banks	= ARRAY_SIZE(exynos1280_pin_banks7),
	},
};

const struct samsung_pinctrl_of_match_data exynos1280_of_data __initconst = {
	.ctrl		= exynos1280_pin_ctrl,
	.num_ctrl	= ARRAY_SIZE(exynos1280_pin_ctrl),
};
